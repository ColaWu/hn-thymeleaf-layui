...
public class MyConstants {
    ...
    public static final int errorRoleCode=2;
    public static final int errorKeyCode=3;
    public static final String  errorRoleMsg="角色已存在";
    public static final String  errorKeyMsg="权限字符已存在";
