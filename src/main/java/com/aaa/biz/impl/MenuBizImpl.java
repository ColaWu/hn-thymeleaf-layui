...
import com.aaa.entity.LayUiTreeTable;
...
public class MenuBizImpl implements MenuBiz {
    ...
    public LayUiTreeTable selectMenu()
    {
        ...
        layUiTreeTable.setMsg("");
        layUiTreeTable.setData(menus);
        layUiTreeTable.setCount(menus.size());
        return layUiTreeTable;

    }

    @Override
    public LayUiTreeTable selectMenuByName() {
        List<Menu> menus = menuMapper.selectAllMenu();
        LayUiTreeTable layUiTreeTable=new LayUiTreeTable();
        layUiTreeTable.setCode(0);
        layUiTreeTable.setMsg("");
    ...
    public List<Menu> selectMenu1() {
        return menuMapper.selectMenu1();
    }

    @Override
    public int SoftdelUserByID(List<?> list) {
        return menuMapper.SoftdelUserByID(list);
    }
